              ...
              , spec = Some
                ...
                , template =
                  { metadata =
                    ...
                    , generation = None Natural
                    , labels = Some
                        (toMap { app = "searcher", deploy = "sourcegraph" })
                    , managedFields =
                        None
                          ( List
                              { apiVersion : Text
                  ...
                  , spec = Some
                    ...
                    , containers =
                      [ { args = None (List Text)
                        ...
                        , image = Some
                            "index.docker.io/sourcegraph/searcher:3.16.1@sha256:12dacc5525827c76217d0aadb21ac51f4e4999e5ba4d4d4d3a40664f10ccfc3b"
