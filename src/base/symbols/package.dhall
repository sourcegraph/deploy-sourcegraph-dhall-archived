              ...
              , spec = Some
                ...
                , template =
                  { metadata =
                    ...
                    , generation = None Natural
                    , labels = Some
                        (toMap { app = "symbols", deploy = "sourcegraph" })
                    , managedFields =
                        None
                          ( List
                              { apiVersion : Text
                  ...
                  , spec = Some
                    ...
                    , containers =
                      [ { args = None (List Text)
                        ...
                        , image = Some
                            "index.docker.io/sourcegraph/symbols:3.16.1@sha256:d45c026ca29023e440ba853454af98f7f32ea275a05b95eea37ce645495847cb"
