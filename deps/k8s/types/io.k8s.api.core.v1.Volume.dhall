...
, configMap :
    Optional
      ./io.k8s.api.core.v1.ConfigMapVolumeSource.dhall sha256:ca17a0474608f919001f642901c11d3e60324a4245879c0bf540eca0ed22357d
, csi :
    Optional
      ./io.k8s.api.core.v1.CSIVolumeSource.dhall sha256:ea2b6f4f0c57878ea1e05f239df124c6bf56990db080216a4e45cc31a9bef890
, downwardAPI :
    Optional
      ./io.k8s.api.core.v1.DownwardAPIVolumeSource.dhall sha256:fc9c281a4dd41484f742cf9aba616a15e7be1742ec05ba5b90ef2fce6c78df53
, emptyDir :
    Optional
...
, iscsi :
    Optional
      ./io.k8s.api.core.v1.ISCSIVolumeSource.dhall sha256:c97368d2f80d33cd17e0aaff1bb74cd67279f1df91e2d96065fd52dc52e550ef
, nfs :
    Optional
...
, projected :
    Optional
      ./io.k8s.api.core.v1.ProjectedVolumeSource.dhall sha256:266ae1679620c829f7dc8d846b05e1873e93119b96dd4ce100d2d199f180a4b6
, quobyte :
    Optional
...
, secret :
    Optional
      ./io.k8s.api.core.v1.SecretVolumeSource.dhall sha256:e6c0e211be14b9d7339669546a704b14dfdf27fb0985921ee3378ac014db0831
, storageos :
    Optional
